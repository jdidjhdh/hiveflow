...
| Language | Path | Site |
|----------|------|------|
| English | [`docs/en/`](en/) | [hiveflow.github.io/hiveflow/en/](https://jdidjhdh.github.io/hiveflow/en/) |
| 简体中文 | [`docs/zh/`](zh/) | [hiveflow.github.io/hiveflow/zh/](https://jdidjhdh.github.io/hiveflow/zh/) |

Shared assets (logo, images): [`docs/assets/`](https://github.com/jdidjhdh/hiveflow/tree/main/docs/assets)
...
Navigation is defined per locale in [`mkdocs.yml`](https://github.com/jdidjhdh/hiveflow/blob/main/mkdocs.yml) under the `i18n` plugin.
