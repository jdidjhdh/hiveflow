...
class OpenAIClient(LLMClient):
    ...
    @staticmethod
    def _to_tool_defs(tools: Optional[List[LLMToolDefinition]]) -> Optional[List[Dict[str, Any]]]:
...
class MockLLMClient(LLMClient):
    ...
    def __init__(self, response: str = "mock response", tool_calls: Optional[List[dict]] = None):
